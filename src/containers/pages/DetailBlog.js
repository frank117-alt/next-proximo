    ...
    return(
        ...
        </Helmet>
        {
            ...
            <div className="mt-5 border-t border-gray-200">
                    ...
                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        {
                            ...
                            :
                            <>
                                <span className="flex-grow text-white text-lg">{post.slug}</span>
                                <span className="ml-4 flex-shrink-0">
                                    <div
                ...
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                    <dt className="text-lg font-medium text-gray-100">Description</dt>
                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                        {
                            updateDescription ?
                            <>
                            ...
                            :
                            <>
                                <span className="flex-grow text-white text-lg">{post.description}</span>
                                <span className="ml-4 flex-shrink-0">
                                    <div
                ...
                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                    <dt className="text-lg font-medium text-white">Category</dt>
                                ...
                                <span className="flex-grow">
                                    {
                                        ...
                                        categories.map(category=>{
                                            if(category.sub_categories.length === 0){
                                                return(
                                                    <div key={category.id} className='flex items-center text-white h-5'>
                                                    <input
                                                        onChange={e => onChange(e)}
                                                    ...
                                                    />
                                                    <label className="ml-3 text-lg dark:text-dark-txt text-white font-light">
                                                        {category.name}
                                                    </label>
                                                    </div>
                                                )
            ...
            <Dialog as="div" className="relative z-10" onClose={setOpen}>
                ...
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:p-6">
                        ...
                        <div className="mt-3 text-center text-white sm:mt-5">
